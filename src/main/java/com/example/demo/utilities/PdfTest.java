...
public class PdfTest {
    ...
    public static void makeRegPDF (Student student, ByteArrayOutputStream stream) {
        ...
        try {
            ...
            //student id
            makeTextBox(pdfDoc,student.getStudentId(),96, 684, 127, 16,1);
            ...
            makeCheckBox(pdfDoc,student.isRecievGreiveVet(),33,604,5,5,1);
            //Last Name
            makeTextBox(pdfDoc,student.getLastname(),129, 543, 179, 16,1);
            makeTextBox(pdfDoc,student.getLastname(),20, 612, 240, 22,2);
            //First Name
            makeTextBox(pdfDoc,student.getFirstname(),310, 543, 180, 16,1);
            makeTextBox(pdfDoc,student.getFirstname(),278, 619, 241, 22,2);
            //middle initial
            makeTextBox(pdfDoc,student.getMiddleInitial(),505, 543, 48, 16,1);
            makeTextBox(pdfDoc,student.getMiddleInitial(),544, 609, 19, 22,2);
            //Address
            makeTextBox(pdfDoc,student.getAddress(),130,517,365,15,1);
            makeTextBox(pdfDoc,student.getAddress(),55,576,432,22,2);
            //Apt num
            makeTextBox(pdfDoc,student.getAptnum(),504,517,87,15,1);
            makeTextBox(pdfDoc,student.getAptnum(),514,577,70,22,2);
            //City
            makeTextBox(pdfDoc,student.getCity(),129,491,273,15,1);
            makeTextBox(pdfDoc,student.getCity(),55,538,274,22,2);
            //State
            makeTextBox(pdfDoc,student.getState(),412,491,40,15,1);
            makeTextBox(pdfDoc,student.getState(),360,538,34,22,2);
            //Zipcode
            makeTextBox(pdfDoc,student.getZipcode(),488,491,100,14,1);
            makeTextBox(pdfDoc,student.getZipcode(),426,538,160,22,2);
            //Home Phone
            makeTextBox(pdfDoc,student.getHomephone(),128,458,209,16,1);
            makeTextBox(pdfDoc,student.getHomephone(),55,502,174,22,2);
            //Fax
            makeTextBox(pdfDoc,student.getFax(),55,475,174,22,2);
            //Work Phone
            makeTextBox(pdfDoc,student.getWorkPhone(),492,180,88,13,1);
            makeTextBox(pdfDoc,student.getWorkPhone(),263,512,174,22,2);
            //Email
            makeTextBox(pdfDoc,student.getEmail(),379,457,200,16,1);
            ...
            //Gender
            makeTextBox(pdfDoc,student.getGender(),513,318,66,20,1);
            ...
            //Us Citizen
            makeCheckBox(pdfDoc,student.isCitizen(),36,396,6,6,1);
